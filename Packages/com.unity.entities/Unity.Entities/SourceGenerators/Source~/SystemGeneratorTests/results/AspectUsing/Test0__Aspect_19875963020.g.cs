namespace Test
{
	...
	public readonly partial struct MyAspect : global::Unity.Entities.IAspect, global::Unity.Entities.IAspectCreate<MyAspect>
	{
		/// <summary>
		/// Construct an instance of the enclosing aspect from all required data references.
		/// </summary>
		public MyAspect(global::Unity.Entities.RefRW<global::Unity.Entities.Tests.EcsTestData> myaspect_ecstestdataRef)
		{
			this.EcsTestData = myaspect_ecstestdataRef;
		}
		...
		public MyAspect CreateAspect(global::Unity.Entities.Entity entity, ref global::Unity.Entities.SystemState systemState)
		{
		...
		public struct Lookup : global::Unity.Entities.Internal.InternalCompilerInterface.IAspectLookup<MyAspect>
		{
			...
			{
				this.MyAspect_EcsTestDataCAc = state.GetComponentLookup<global::Unity.Entities.Tests.EcsTestData>(false);
			}
			...
			{
				this.MyAspect_EcsTestDataCAc.Update(ref state);
			}
			...
			/// <param name="entity">The entity to create the aspect struct from.</param>
			/// <returns>Instance of the aspect struct pointing at a specific entity's components data.</returns>
			public MyAspect this[global::Unity.Entities.Entity entity]
			{
				get
				{
		...
		{
			/// <summary>
			/// Chunk data for aspect field 'MyAspect.EcsTestData'
			/// </summary>
			public global::Unity.Collections.NativeArray<global::Unity.Entities.Tests.EcsTestData> MyAspect_EcsTestDataNaC;
			...
			public MyAspect this[int index]
				=> new MyAspect(new global::Unity.Entities.RefRW<global::Unity.Entities.Tests.EcsTestData>(this.MyAspect_EcsTestDataNaC, index));
		...
		{
			global::Unity.Entities.ComponentTypeHandle<global::Unity.Entities.Tests.EcsTestData> MyAspect_EcsTestDataCAc;
			...
			{
				this.MyAspect_EcsTestDataCAc = state.GetComponentTypeHandle<global::Unity.Entities.Tests.EcsTestData>(false);
			}
			...
			public ResolvedChunk Resolve(global::Unity.Entities.ArchetypeChunk chunk)
			{
				...
				resolved.MyAspect_EcsTestDataNaC = chunk.GetNativeArray(ref this.MyAspect_EcsTestDataCAc);
		...
		/// </summary>
		public struct Enumerator : global::System.Collections.Generic.IEnumerator<MyAspect>, global::System.Collections.Generic.IEnumerable<MyAspect>
		{
		    ...
		    global::System.Collections.Generic.IEnumerator<MyAspect> global::System.Collections.Generic.IEnumerable<MyAspect>.GetEnumerator() => throw new global::System.NotImplementedException();
