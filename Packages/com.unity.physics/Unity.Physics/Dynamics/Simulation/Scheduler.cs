...
namespace Unity.Physics
{
    ...
    internal struct DispatchPairSequencer : IDisposable
    {
            ...
            bool multiThreaded = true)
        {
            ...
            if (!multiThreaded)
            {
                ...
                returnHandles.FinalExecutionHandle = new CreateDispatchPairsJobST
                {
                    ...
                    Joints = world.Joints,
#endif
                    NumDynamicBodies = world.NumDynamicBodiesCapacity
                }.Schedule(inputDeps);
        ...
        private struct CreateUnsortedDispatchPairsJob : IJob
        {
            ...
            public void Execute()
            {
                ExecuteImpl(DynamicVsDynamicPairs, StaticVsDynamicPairs,
#if !UNITY_PHYSICS_DISABLE_JOINTS
                    Joints,
#endif
                    UnsortedDispatchPairs, DispatchPairsUninitialized);
            }
