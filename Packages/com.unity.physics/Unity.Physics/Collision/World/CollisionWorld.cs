...
namespace Unity.Physics
{
    ...
    public struct CollisionWorld : ICollidable, IAspectQueryable, IDisposable
    {
        ...
        public int NumBodiesCapacity => m_Bodies.Length;
        ...
        public int NumStaticBodiesCapacity => Broadphase.NumStaticBodiesCapacity;
        ...
        public int NumDynamicBodiesCapacity => Broadphase.NumDynamicBodiesCapacity;
        ...
        private void SetCapacity(int numBodies)
        {
            ...
            {
                m_Bodies.Dispose();
                m_Bodies = new NativeArray<RigidBody>(math.ceilpow2(numBodies), Allocator.Persistent, NativeArrayOptions.UninitializedMemory);
#if !UNITY_PHYSICS_DISABLE_JOINTS
        ...
        public void CopyFrom(CollisionWorld collisionWorld)
        {
#if ENABLE_UNITY_COLLECTIONS_CHECKS
            if (NumStaticBodiesCapacity < collisionWorld.NumStaticBodies || NumDynamicBodiesCapacity < collisionWorld.NumDynamicBodies)
            {
                throw new InvalidOperationException("Cannot copy from CollisionWorld with more bodies than our capacity");
            }
#endif
            collisionWorld.m_Bodies.GetSubArray(0, collisionWorld.NumBodies).CopyTo(m_Bodies.GetSubArray(0, collisionWorld.NumBodies));
            Broadphase.CopyFrom(collisionWorld.Broadphase);
        }
        ...
        [BurstCompile]
        private struct UpdateRigidBodyTransformsJob : IJob
        {
