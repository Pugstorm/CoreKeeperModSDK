...
namespace Unity.Physics.GraphicsIntegration
{
    ...
    /// <summary>
    /// Our own component that enables smoothing from network misspredictions
    /// </summary>
    public struct PredictedLocalTransformSmoothingCD : IComponentData
    {
        public bool isSmoothing;
        public float3 smoothedPosition;
        public float3 physicsSmoothingStartPosition;
        public float3 lastFinalFullPredictedTickPosition;
