    ...
    public struct GhostSnapshotData
    {
        ...
        public unsafe void CopyToSnapshot(ref Snapshot snapshot, ref IComponentData component)
        {
            if (true)
            {
                ...
                snapshot.__GHOST_FIELD_NAME__X = (int)math.round(component.__GHOST_FIELD_REFERENCE__.value.x * __GHOST_QUANTIZE_SCALE__);
                snapshot.__GHOST_FIELD_NAME__Y = (int)math.round(component.__GHOST_FIELD_REFERENCE__.value.y * __GHOST_QUANTIZE_SCALE__);
                snapshot.__GHOST_FIELD_NAME__Z = (int)math.round(component.__GHOST_FIELD_REFERENCE__.value.z * __GHOST_QUANTIZE_SCALE__);
                snapshot.__GHOST_FIELD_NAME__W = (int)math.round(component.__GHOST_FIELD_REFERENCE__.value.w * __GHOST_QUANTIZE_SCALE__);
                #endregion
            }
        }
