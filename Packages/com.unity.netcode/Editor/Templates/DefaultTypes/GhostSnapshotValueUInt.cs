...
namespace Generated
{
    public struct GhostSnapshotData
    {
        struct Snapshot
        {
            ...
            public uint __GHOST_FIELD_NAME__;
            #endregion
        }
        ...
        public unsafe void CopyToSnapshot(ref Snapshot snapshot, ref IComponentData component)
        {
            if (true)
            {
                ...
                snapshot.__GHOST_FIELD_NAME__ = (uint)component.__GHOST_FIELD_REFERENCE__;
                #endregion
            }
        }
        ...
        public void SerializeCommand(ref DataStreamWriter writer, in IComponentData data, in IComponentData baseline, StreamCompressionModel compressionModel)
        {
            ...
            writer.WriteUInt((uint)data.__COMMAND_FIELD_NAME__);
            #endregion
            #region __COMMAND_WRITE_PACKED__
            writer.WritePackedUIntDelta((uint)data.__COMMAND_FIELD_NAME__, (uint)baseline.__COMMAND_FIELD_NAME__, compressionModel);
            #endregion
        }
        ...
        public void DeserializeCommand(ref DataStreamReader reader, ref IComponentData data, in IComponentData baseline, StreamCompressionModel compressionModel)
        {
            ...
            data.__COMMAND_FIELD_NAME__ = (__COMMAND_FIELD_TYPE_NAME__) reader.ReadUInt();
            #endregion
            #region __COMMAND_READ_PACKED__
            data.__COMMAND_FIELD_NAME__ = (__COMMAND_FIELD_TYPE_NAME__) reader.ReadPackedUIntDelta((uint)baseline.__COMMAND_FIELD_NAME__, compressionModel);
            #endregion
        }
        ...
        private static void ReportPredictionErrors(ref IComponentData component, in IComponentData backup, ref UnsafeList<float> errors, ref int errorIndex)
        {
            ...
            errors[errorIndex] = math.max(errors[errorIndex],
                (component.__GHOST_FIELD_REFERENCE__ > backup.__GHOST_FIELD_REFERENCE__) ?
                (component.__GHOST_FIELD_REFERENCE__ - backup.__GHOST_FIELD_REFERENCE__) :
                (backup.__GHOST_FIELD_REFERENCE__ - component.__GHOST_FIELD_REFERENCE__));
            ++errorIndex;
            #endregion
        }
