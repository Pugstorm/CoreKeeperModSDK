...
{
	/// <summary>
	///     Represents the "Item Pick-Up Notifier" feature in the game, which provides notifications whenever items are picked
	///     up from the ground.
	...
	///         <item>
	///             <description>
	///                 Configuration of the feature's enabled state and notification parameters,
	///                 such as the aggregation delay (<see cref="AggregateDelay" />), which controls how often notifications
	///                 are displayed.
	///             </description>
	///         </item>
	///         <item>
