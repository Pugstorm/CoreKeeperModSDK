...
namespace CK_QOL_Collection.Core
{
    ...
    internal static class Configuration
    {
        ...
        internal static ConfigFile Initialize(LoadedMod modInfo)
        {
            ...
            // General settings
            ConfigFile.Bind(Sections.General.Options.Enabled.Definition, 
                Sections.General.Options.Enabled.Default,
                Sections.General.Options.Enabled.Description);

            // CraftingRange settings
            ConfigFile.Bind(Sections.CraftingRange.Options.Enabled.Definition,
                Sections.CraftingRange.Options.Enabled.Default,
                Sections.CraftingRange.Options.Enabled.Description);
            ConfigFile.Bind(Sections.CraftingRange.Options.Distance.Definition,
                Sections.CraftingRange.Options.Distance.Default,
                Sections.CraftingRange.Options.Distance.Description);
            ConfigFile.Bind(Sections.CraftingRange.Options.ChestLimit.Definition,
                Sections.CraftingRange.Options.ChestLimit.Default,
                Sections.CraftingRange.Options.ChestLimit.Description);

            // QuickStash settings
            ConfigFile.Bind(Sections.QuickStash.Options.Enabled.Definition, 
                Sections.QuickStash.Options.Enabled.Default,
                Sections.QuickStash.Options.Enabled.Description);
            ConfigFile.Bind(Sections.QuickStash.Options.Distance.Definition,
                Sections.QuickStash.Options.Distance.Default, 
                Sections.QuickStash.Options.Distance.Description);

            // QuickStash keybinds
            RewiredExtensionModule.AddKeybind(Sections.QuickStash.KeyBinds.QuickStashKeyBindName,
                ...
                internal static class Options
                {
                    ...
                    internal static class ChestLimit
                    {
                        ...
                        private const string Text =
                            "The maximum amount of chests to include. Currently more than 8 chests will break the game.";
